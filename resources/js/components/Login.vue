<template>
    ...
    <div class="col-md-6 col-lg-6 col-12 mx-auto p-0">
        <div class="color-main-color w-100 mx-auto bg-transparent">
            <div class="login-box">
                <div class="login-snip bg-main-color"> <input id="tab-1" type="radio" name="tab" class="sign-in" checked><label for="tab-1" class="tab">Login</label> <input id="tab-2" type="radio" name="tab" class="sign-up"><label for="tab-2" class="tab">Sign Up</label>
                    <div class="login-space">
                        <div class="login">
                            <div class="group"> <label for="user" class="label">Email</label> <input id="user" type="text" class="input" placeholder="Enter your username"> </div>
                            ...
                            <div class="group"> <input type="submit" class="button bg-logo" value="Sign In"> </div>
                            <div class="hr"></div>
                            <div class="foot color-logo"> <a href="#">Forgot Password?</a> </div>
                        </div>
                        <div class="sign-up-form">
                            ...
                            <div class="group"> <input type="submit" class="button bg-logo" value="Sign Up"> </div>
                            <div class="hr"></div>
                            <div class="foot"> <label for="tab-1 color-logo">Already Member?</label> </div>
                        </div>
                    </div>
                </div>
            </div>
